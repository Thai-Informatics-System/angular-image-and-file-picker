...
@Component({
  selector: 'angular-pdf-viewer',
  standalone: false,
  templateUrl: './angular-pdf-viewer.component.html',
  styleUrl: './angular-pdf-viewer.component.css',
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class AngularPdfViewerComponent implements OnChanges {
