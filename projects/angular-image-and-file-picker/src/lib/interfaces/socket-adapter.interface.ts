 ...
 */
export interface AngularRemoteUploadConfig {
  /**
   ...
   */
  apiEndpoints?: AngularRemoteUploadApiEndpoints;

  /**
   * QR code configuration
   */
  qrCode?: AngularQrCodeConfig;

  /**
   * Pairing configuration
   */
  pairing?: AngularPairingConfig;
 ...
 */
export interface AngularRemoteUploadApiEndpoints {
  /**
 ...
 */
export interface AngularQrCodeConfig {
  /**
 ...
 */
export interface AngularPairingConfig {
  /**
  ...
  /**
   * Storage key for pairing data (default: 'angular-remote-upload-pairing')
   */
  storageKey?: string;
 ...
 */
export interface AngularPairingSession {
  /**
   * Unique pairing code
   */
  pairingCode: string;
 ...
 */
export interface AngularRemoteUploadEvent {
  /**
   * The uploaded file data
   */
  file: AngularRemoteUploadedFile;
 ...
 */
export interface AngularRemoteUploadedFile {
  /**
 ...
 */
export interface AngularRemoteUploadMessage {
  /**
   * Message type
   */
