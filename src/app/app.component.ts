...
import { DialogConfig, OptionConfig, AngularImageAndFilePickerModule, AngularRemoteUploadApiEndpoints, AngularRemoteUploadConfig, UrlConfig } from 'angular-image-and-file-picker';
import { MockSocketAdapterService } from './services/mock-socket-adapter.service';

@Component({
  selector: 'app-root',
  imports: [CommonModule, AngularImageAndFilePickerModule],
  templateUrl: './app.component.html',
  styleUrl: './app.component.scss'
})
export class AppComponent {
  title = 'angular-image-and-file-picker-project';
  selectedId = 1;
  ...
  private apiEndpoints!: AngularRemoteUploadApiEndpoints;
